  ...
  "fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-gray-950",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4 bg-primary-950 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
    ...
    <SheetPortal>
      ...
      >
        <SheetPrimitive.Close className="absolute right-8 top-8 outline-none transition-opacity">
          <IoMdClose className="text-4xl text-accent-400" />
